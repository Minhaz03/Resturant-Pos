...
<div class="d-flex align-items-center gap-3 mb-4">
    ...
    <div><h4 class="fw-bold mb-0" style="color:var(--secondary)">Add Category</h4></div>
</div>
<div class="row justify-content-center">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('categories.store') }}" enctype="multipart/form-data" id="categoryCreateForm">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="text-muted" style="font-size:0.78rem;margin-top:4px">
                            <i class="bi bi-info-circle me-1"></i>Drag & drop or click to upload. Max 4MB. JPG, PNG, GIF, WebP supported.
                        </div>
                    </div>
                    <div class="mb-3">
