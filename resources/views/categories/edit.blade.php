...
<div class="row justify-content-center">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('categories.update',$category) }}" enctype="multipart/form-data" id="categoryEditForm">
                    @csrf @method('PUT')
...
<script>
    ...
    @php
        ...
        $hasImage = $category->hasMedia('image') || $category->image;
    @endphp
    ...
    @if($hasImage)
    // Load existing image as a mock file in FilePond for preview
    pondConfig.files = [{
    ...
    const pond = FilePond.create(inputElement, pondConfig);
</script>
@endpush
