                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('menu.update', $menuItem) }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4"><label class="form-label">Price (৳) <span
                            ...
                            <div class="col-md-4"><label class="form-label">Discount (%)</label>
                                <input type="number" step="0.01" name="discount" class="form-control"
                                    value="{{ old('discount', $menuItem->discount) }}">
                            </div>
                            ...
                            <div class="col-md-4"><label class="form-label">Prep Time (min)</label>
                                <input type="number" name="prep_time" class="form-control"
                                    value="{{ old('prep_time', $menuItem->prep_time) }}">
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_featured" value="1"
                                        id="feat" {{ old('is_featured', $menuItem->is_featured) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="status" value="1"
                                        id="stat" {{ old('status', $menuItem->status) ? 'checked' : '' }}>
                        ...
                        <div class="d-flex gap-2 mt-4">
                            <button type="submit" class="btn btn-primary"><i
                                    class="bi bi-check2 me-1"></i>Update</button>
