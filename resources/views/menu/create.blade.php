                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <div class="text-muted" style="font-size:0.78rem;margin-top:4px">
                                    <i class="bi bi-info-circle me-1"></i>Drag & drop or click to upload. Max 4MB. JPG,
                                    PNG, GIF, WebP supported.
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_available" value="1"
                                        id="avail" {{ old('is_available', 1) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_featured" value="1"
                                        id="feat" {{ old('is_featured') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="status" value="1"
                                        id="stat" {{ old('status', 1) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="stat">Active</label>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex gap-2 mt-4">
                            <button type="submit" class="btn btn-primary"><i class="bi bi-check2 me-1"></i>Save
                                Item</button>
