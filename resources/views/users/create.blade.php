                    ...
                    <form method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">@csrf
                        <div class="row g-3">
                            ...
                            <div class="col-md-6"><label class="form-label fw-semibold">Phone</label><input type="text"
                                    name="phone" class="form-control" value="{{ old('phone') }}"></div>
                            ...
                            <div class="col-md-6"><label class="form-label fw-semibold">Confirm Password <span
                            ...
                            <div class="col-md-6"><label class="form-label fw-semibold">Avatar</label><input type="file"
                                    id="userAvatar" name="avatar" accept="image/*"></div>
                        </div>
                        <hr>
