...
<body>
    ...
    <div class="summary-grid">
        ...
        <div class="summary-box">
            ...
            <div class="value">{{ number_format($summary['avg_order_value'] ?? 0, 2) }}</div>
        </div>
        <div class="summary-box">
            <div class="label">Total Tax</div>
            <div class="value">{{ number_format($summary['total_tax'] ?? 0, 2) }}</div>
        </div>
    </div>
    <table>
        <thead>
        ...
        <tfoot>
            <tr>
                ...
                <td>{{ number_format(($summary['total_revenue'] ?? 0) - ($summary['total_tax'] ?? 0) - ($summary['total_discount'] ?? 0), 2) }}
                </td>
            </tr>
        </tfoot>
    </table>
    <div class="footer">
        Generated on {{ now()->format('d M Y, h:i A') }} &bull;
